...
"""
Model layouts:
               1. This model first embeds encoder_inputs by a newly created embedding (of shape
...
tf.app.flags.DEFINE_float("max_gradient_norm", gradient_clip_norm,
                          "Clip gradients to this norm.")
tf.app.flags.DEFINE_integer("batch_size", batch_size,
                            "Batch size to use during training.")
tf.app.flags.DEFINE_integer("size", num_of_nodes, "Size of each model layer.")
tf.app.flags.DEFINE_integer("num_layers", num_of_layers, "Number of layers in the model.")
tf.app.flags.DEFINE_integer("from_vocab_size", from_vocab_size, "English vocabulary size.")
tf.app.flags.DEFINE_integer("to_vocab_size", to_vocab_size, "French vocabulary size.")
tf.app.flags.DEFINE_string("data_dir", data_dir, "Data directory")
tf.app.flags.DEFINE_string("train_dir", trained_dir, "Training directory.")
...
tf.app.flags.DEFINE_integer("steps_per_checkpoint", how_many_steps_per_save,
                            "How many training steps to do per checkpoint.")
tf.app.flags.DEFINE_boolean("decode", decoding_mode_tf,
...
def create_model(session, use_lstm_tf_param, sample_softmax_size_param, forward_only_tf_param):
  ...
  model = seq2seq_model.Seq2SeqModel(
      ...
      use_lstm=use_lstm_tf_param,
      num_samples=sample_softmax_size_param,
      forward_only=forward_only_tf_param,
      dtype=dtype)
...
def train():
  ...
  with tf.Session() as sess:
    ...
    model = create_model(sess, use_lstm_tf, sample_softmax_size, False)
...
def decode():
  with tf.Session() as sess:
    ...
    model = create_model(sess, use_lstm_tf, sample_softmax_size, True)
